...
class MCCBoard:
   ...
   def __init__(self):
      ...
      if self.version == 1:
         ...
         self.pc1 = POEController(I2C_POE_BUS, I2C_POE0_ADDR, (),) 
         self.pc2 = POEController(I2C_POE_BUS, I2C_POE1_ADDR, (),) 

         self.sw.add_controller(self.pc1)
         self.sw.add_controller(self.pc2)

         self.sfp = [
            SFP(I2C_SFP0_BUS, I2C_SFP_ADDR),
            SFP(I2C_SFP1_BUS, I2C_SFP_ADDR)
         ]
